...
class VirtualObjectARView: ARSCNView {
     ...
     */
    func worldPosition(fromScreenPosition position: CGPoint, objectPosition: SIMD3<Float>?, infinitePlane: Bool = false) -> (position: SIMD3<Float>, planeAnchor: ARPlaneAnchor?, isOnPlane: Bool)? {
        /*
...
extension VirtualObjectARView.FeatureHitTestResult {
    ...
    init(featurePoint: SIMD3<Float>, ray: VirtualObjectARView.HitTestRay) {
