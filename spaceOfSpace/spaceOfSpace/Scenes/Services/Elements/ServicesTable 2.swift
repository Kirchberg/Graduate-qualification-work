...
extension ServicesViewController: UITableViewDelegate,  UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.cellDesc.text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elit."
        case 1:
            cell.cellLabel.text = "APOD"
            cell.cellImg.image=UIImage(named: "Image")
            cell.cellDesc.text="Astronomy Picture of the Day"
        default:
...
class ServicesCell: UITableViewCell {
    ...
    func setupView() {
        ...
        cellLabel.widthAnchor.constraint(equalToConstant: 99).isActive = true
